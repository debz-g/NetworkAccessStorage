 ...
 */
public abstract class Hilt_UploadFileFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_UploadFileFragment() {
    super();
  }

  Hilt_UploadFileFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UploadFileFragment_GeneratedInjector) this.generatedComponent()).injectUploadFileFragment(UnsafeCasts.<UploadFileFragment>unsafeCast(this));
    }
  }
