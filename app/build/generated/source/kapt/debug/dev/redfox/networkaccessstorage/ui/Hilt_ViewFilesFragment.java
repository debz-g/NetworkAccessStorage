 ...
 */
public abstract class Hilt_ViewFilesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ViewFilesFragment() {
    super();
  }

  Hilt_ViewFilesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ViewFilesFragment_GeneratedInjector) this.generatedComponent()).injectViewFilesFragment(UnsafeCasts.<ViewFilesFragment>unsafeCast(this));
    }
  }
